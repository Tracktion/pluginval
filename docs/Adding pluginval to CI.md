...
$ unzip pluginval
$ pluginval.app/Contents/MacOS/pluginval validate --output-dir "./bin" "<path_to_plugin>" || exit 1
```
...
$ unzip pluginval
$ ./pluginval validate --output-dir "./bin" "<path_to_plugin>" || exit 1
```
...
> pluginval.exe validate --output-dir "./bin" "<path_to_plugin>"
